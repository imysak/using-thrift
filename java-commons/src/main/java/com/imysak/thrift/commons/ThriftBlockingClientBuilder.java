 ...
 */
public class ThriftBlockingClientBuilder<T> extends AbstractThriftClientBuilder<T> {
     ...
     */
    public ThriftBlockingClientBuilder(final Class<? extends T> clientClass, final String host, final int port)
